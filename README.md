...
## Babashka
1. [Peloading code on every invocation](https://github.com/exupero/til/blob/main/Babashka/peloading-code-on-every-invocation.md)
...
4. [Locking on an object](https://github.com/exupero/til/blob/main/Clojure/locking-on-an-object.md)
5. [Meander patterns match remaining key-values with &](https://github.com/exupero/til/blob/main/Clojure/meander-patterns-match-remaining-key-values-with-.md)
6. [Meander rewrite forms can recurse using meander.epsilon/app](https://github.com/exupero/til/blob/main/Clojure/meander-rewrite-forms-can-recurse-using-meander-epsilon-app.md)
7. [Parse sequence of JSON values with cheshire.core](https://github.com/exupero/til/blob/main/Clojure/parse-sequence-of-json-values-with-cheshire-core.md)
8. [Re-frame has a subscription shorthand for accessing a DB field](https://github.com/exupero/til/blob/main/Clojure/re-frame-has-a-subscription-shorthand-for-accessing-a-db-field.md)
9. [Running Clojure code as a shell script](https://github.com/exupero/til/blob/main/Clojure/running-clojure-code-as-a-shell-script.md)
10. [Specify multiple aliases with ':'](https://github.com/exupero/til/blob/main/Clojure/specify-multiple-aliases-with-.md)
11. [Use Meander's `$` to search nested structures](https://github.com/exupero/til/blob/main/Clojure/use-meanders-to-search-nested-structures.md)
12. [Use `update-vals` to map a hash-map's values](https://github.com/exupero/til/blob/main/Clojure/use-update-vals-to-map-a-hash-maps-values.md)
13. [`atom` can take a validator function](https://github.com/exupero/til/blob/main/Clojure/-atom-can-take-a-validator-function.md)
14. [cljc.java-time supports ClojureScript](https://github.com/exupero/til/blob/main/Clojure/cljc-java-time-supports-clojurescript.md)
15. [clojure.java.io/file can take multiple arguments](https://github.com/exupero/til/blob/main/Clojure/clojure-java-io-file-can-take-multiple-arguments.md)
16. [clojure.test has `*test-out*` var that captures test log](https://github.com/exupero/til/blob/main/Clojure/clojure-test-has-test-out-var-that-captures-test-log.md)
17. [hashp can be added to a shadow-cljs project](https://github.com/exupero/til/blob/main/Clojure/hashp-can-be-added-to-a-shadow-cljs-project.md)
18. [shadow-cljs has an -A option for additional aliases](https://github.com/exupero/til/blob/main/Clojure/shadow-cljs-has-an-a-option-for-additional-aliases.md)
...
3. [Edit and replay bisection](https://github.com/exupero/til/blob/main/Git/edit-and-replay-bisection.md)
4. [Force output to be colored](https://github.com/exupero/til/blob/main/Git/force-output-to-be-colored.md)
5. [Move an existing branch to another commit](https://github.com/exupero/til/blob/main/Git/move-an-existing-branch-to-another-commit.md)
6. [Pre-commit hook to check for text in changed files](https://github.com/exupero/til/blob/main/Git/pre-commit-hook-to-check-for-text-in-changed-files.md)
7. [Pre-populate commit message](https://github.com/exupero/til/blob/main/Git/pre-populate-commit-message.md)
8. [Pull with --rebase gets forced pushes](https://github.com/exupero/til/blob/main/Git/pull-with-rebase-gets-forced-pushes.md)
9. [Submit patch hunk with single key](https://github.com/exupero/til/blob/main/Git/submit-patch-hunk-with-single-key.md)
...
2. [Conjure stores result of last evaluation in `c` register](https://github.com/exupero/til/blob/main/Neovim/conjure-stores-result-of-last-evaluation-in-c-register.md)
3. [Define user command from Lua](https://github.com/exupero/til/blob/main/Neovim/define-user-command-from-lua.md)
4. [Fix treesitter error when viewing :help](https://github.com/exupero/til/blob/main/Neovim/fix-treesitter-error-when-viewing-help.md)
5. [List keymappings and their origins](https://github.com/exupero/til/blob/main/Neovim/list-keymappings-and-their-origins.md)
6. [Motion to visually select string without leading whitespace](https://github.com/exupero/til/blob/main/Neovim/motion-to-visually-select-string-without-leading-whitespace.md)
7. [Move split to new tab with Ctrl-w T](https://github.com/exupero/til/blob/main/Neovim/move-split-to-new-tab-with-ctrl-w-t.md)
...
14. [UltiSnips supports regex replacement on placeholders](https://github.com/exupero/til/blob/main/Neovim/ultisnips-supports-regex-replacement-on-placeholders.md)
15. [Vim-medieval configuration to run Clojure code with Babashka](https://github.com/exupero/til/blob/main/Neovim/vim-medieval-configuration-to-run-clojure-code-with-babashka.md)
16. [after/ directories have to be included on runtimepath](https://github.com/exupero/til/blob/main/Neovim/after-directories-have-to-be-included-on-runtimepath.md)
17. [vim-fugitive includes GBrowse command](https://github.com/exupero/til/blob/main/Neovim/vim-fugitive-includes-gbrowse-command.md)
...
3. [Filter Pytest tests with boolean logic](https://github.com/exupero/til/blob/main/Python/filter-pytest-tests-with-boolean-logic.md)
4. [Pip install globally, regardless of active virtualenv](https://github.com/exupero/til/blob/main/Python/pip-install-globally-regardless-of-active-virtualenv.md)
5. [Redirect print to a file with redirect_stdout](https://github.com/exupero/til/blob/main/Python/redirect-print-to-a-file-with-redirect-stdout.md)
6. [Show code's AST](https://github.com/exupero/til/blob/main/Python/show-codes-ast.md)
7. [Specify default options to Pytest](https://github.com/exupero/til/blob/main/Python/specify-default-options-to-pytest.md)
8. [`functools.lru_cache` decorator provides method to clear cache](https://github.com/exupero/til/blob/main/Python/-functools-lru-cache-decorator-provides-method-to-clear-cache.md)
9. [`functools.lru_cache` provides access to wrapped function](https://github.com/exupero/til/blob/main/Python/-functools-lru-cache-provides-access-to-wrapped-function.md)
10. [line-profiler library](https://github.com/exupero/til/blob/main/Python/line-profiler-library.md)
...
7. [Graphviz nodes can link to URLs](https://github.com/exupero/til/blob/main/Unix/graphviz-nodes-can-link-to-urls.md)
